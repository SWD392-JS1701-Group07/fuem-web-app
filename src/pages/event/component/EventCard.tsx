    ...
    >
      <div className="mx-auto flex w-96 cursor-pointer flex-col p-4">
        ...
        <h2 className="mt-1 italic text-gray-300">
          {formatDateTime(event.startSellDate, 'date')} to{' '}
          {formatDateTime(event.endSellDate, 'date')}
        </h2>
        ...
        <div className="tokenInfo my-4 flex items-center justify-between">
          ...
          <div className="duration flex items-center text-gray-400">
            ...
            <p>
              {formatDateTime(event.startSellDate, 'time') +
                ' - ' +
                formatDateTime(event.endSellDate, 'time')}
            </p>
          </div>
        </div>
