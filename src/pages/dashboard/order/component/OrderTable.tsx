...
export const columns: ColumnDef<Order>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="capitalize">{row.getValue('orderDate')}</div>
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="capitalize">{row.getValue('customerId')}</div>
  },
  {
    id: 'actions',
    enableHiding: false,
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() => navigate(`/dashboard/order/${row.getValue('id')}/edit`)}
            >
              Edit
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => navigate(`/dashboard/order/${row.getValue('id')}`)}>
              View details
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  key={row.id}
                  onClick={() => navigate(`/dashboard/order/${row.original.id}`)}
